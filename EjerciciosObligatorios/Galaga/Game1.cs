...
namespace Galaga
{
    public class Game1 : Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            aparecerEnemigos.Update(gameTime);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            if (juegoIniciado)
            {
                string startMessage = "Presione [ESPACIO] para continuar";
            ...
            if (puntaje == 100)
            {
                string winMessage = "¡Has logrado salvar al mundo!";
               ...
               imagenes.DrawString(fondoPuntaje, winMessage, winMessagePosition, Color.Yellow); 
     
            }
                else if (juegoCompleto)
            {
                string startMessage = "¡Fin del juego! Los enemigos han destruido al mundo.";
                Vector2 messageSize = fondoPuntaje.MeasureString(startMessage);
                Vector2 messagePosition = new Vector2(
                    (graficos.PreferredBackBufferWidth - messageSize.X) / 2,
                    (graficos.PreferredBackBufferHeight - messageSize.Y) / 2);
